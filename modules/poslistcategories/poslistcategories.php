	...
	protected function installDemoData()
	{
		...
		for ($i = 1; $i <= 5; ++$i)
		{
			...
			foreach ($languages as $language)
			{
				...
				$item->description[$language['id_lang']] = '<p>Discover five of our favourite dresses from our new collection that are destined to be worn and loved immediately.</p>';
			}
			$item->add();
		}
	}

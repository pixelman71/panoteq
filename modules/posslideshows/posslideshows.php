        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
				...
				if($i==1){
					...
					<p class="title1" data-animation="animated fadeInUp">Passion</p>
					<p class="title2" data-animation="animated fadeInUp"><span>infinite</span> creativity.</p>
					<p class="title3" data-animation="animated fadeInUp">Discover five of our favourite dresses from our new collection that are destined to be worn and loved immediately.</p>
					<p class="readmore" data-animation="animated fadeInUp"><a href="12-women"><span>Shop now</span></a></p>
					</div>';
				}elseif($i==2){
					$slide->description[$language['id_lang']] = '<div class="info desc2">
					<p class="title1" data-animation="animated fadeInRight">Min</p>
					<p class="title2" data-animation="animated fadeInRight"><span>season</span> sale</p>
					<p class="title3" data-animation="animated fadeInRight">Discover five of our favourite dresses from our new collection that are destined to be worn and loved immediately.</p>
					<p class="readmore" data-animation="animated fadeInRight"><a href="13-men"><span>Shop now</span></a></p>
					</div>';
				}else{

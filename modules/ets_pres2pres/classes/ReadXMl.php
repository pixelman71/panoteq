    ...
    public function _readXML()
    {
        if (file_exists(dirname(__FILE__) . '/../xml/' . $this->folder . '/' . $this->type . '.xml')) {
            ...
            Tools::jsonEncode(
                array(
                    'error_xml' => true,
                    'link_xml' => $this->getBaseLink() . 'modules/ets_pres2pres/xml/' . $this->folder . '/' . $this->type . '.xml',
                    'file_xml' => $this->type . '.xml',
                    'file_url' => 'modules/ets_pres2pres/xml/' . $this->folder . '/' . $this->type . '.xml',
                )
            )
            );
        }
        if (file_exists(dirname(__FILE__) . '/../xml/' . $this->folder . '/' . $this->type . '_' . $this->currentIndex . '.xml')) {
            ...
            Tools::jsonEncode(
                array(
                    'error_xml' => true,
                    'link_xml' => $this->getBaseLink() . 'modules/ets_pres2pres/xml/' . $this->folder . '/' . $this->type . '_' . $this->currentIndex . '.xml',
                    'file_xml' => $this->type . '_' . $this->currentIndex . '.xml',
                    'file_url' => 'modules/ets_pres2pres/xml/' . $this->folder . '/' . $this->type . '_' . $this->currentIndex . '.xml',
                )
            )
            );
        }

...
<div class="dtm-right-block">
    <div class="panel data_tab_help">
        ...
        <ul>
            <li>{l s='1. Install "Prestashop Connector" on source website. Download Prestashop connector module' mod='ets_pres2pres'}&nbsp;<a href="{$mod_dr_pres2pres|escape:'html':'UTF-8'}plugins/ets_pres2presconnector.zip">{l s='here.' mod='ets_pres2pres'}</a></li>
            ...
            <li>{l s='5. Final tweaks (Clear cache, Regenerate friendly URL, reindex data, recover passwords). Download Prestashop password keeper' mod='ets_pres2pres'}&nbsp;<a href="{$mod_dr_pres2pres|escape:'html':'UTF-8'}plugins/ets_pres2prespwkeeper.zip">{l s='here.' mod='ets_pres2pres'}</a></li>
        </ul>

...
class ProductControllerCore extends ProductPresentingFrontControllerCore
{
    ...
    public function initContent()
    {
        ...
        $ralColors1 = ['#BEBD7F', '#C2B078', '#C6A664', '#E5BE01', '#CDA434', '#A98307', '#E4A010', '#DC9D00', '#8A6642', '#C7B446', '#EAE6CA', '#E1CC4F', '#E6D690', '#EDFF21', '#F5D033',
            '#F8F32B', '#9E9764', '#999950', '#F3DA0B', '#FAD201', '#AEA04B', '#9D9101', '#F4A900', '#D6AE01', '#F3A505', '#EFA94A', '#6A5D4D', '#705335', '#F39F18', '#ED760E', '#C93C20',
            '#CB2821', '#FF7514', '#F44611', '#F75E25', '#F54021', '#D84B20', '#EC7C26', '#E55137', '#C35831', '#AF2B1E', '#A52019', '#A2231D', '#9B111E', '#75151E', '#5E2129', '#412227',
            '#642424', '#781F19', '#C1876B', '#A12312', '#D36E70', '#EA899A', '#B32821', '#E63244', '#D53032', '#CC0605', '#D95030', '#C51D34', '#CB3234', '#B32428', '#721422', '#B44C43',
            '#6D3F5B', '#922B3E', '#DE4C8A', '#641C34', '#6C4675', '#A03472', '#4A192C', '#924E7D', '#A18594', '#CF3476', '#8673A1', '#6C6874', '#354D73', '#1F3438', '#20214F', '#1D1E33',
            '#18171C', '#1E2460', '#3E5F8A', '#26252D', '#025669', '#0E294B', '#231A24', '#3B83BD', '#1E213D', '#606E8C', '#2271B3', '#063971', '#3F888F', '#1B5583', '#1D334A', '#256D7B',
            '#252850', '#49678D', '#5D9B9B', '#2A6478', '#102C54', '#316650', '#287233', '#2D572C', '#424632', '#1F3A3D', '#2F4538', '#3E3B32', '#343B29', '#39352A', '#31372B', '#35682D'
        ];
        $ralColors2 = [
            '#587246', '#343E40', '#6C7156', '#47402E', '#3B3C36', '#1E5945', '#4C9141', '#57A639', '#BDECB6', '#2E3A23', '#89AC76', '#25221B', '#308446', '#3D642D', '#015D52', '#84C3BE',
            '#2C5545', '#20603D', '#317F43', '#497E76', '#7FB5B5', '#1C542D', '#193737', '#008F39', '#78858B', '#8A9597', '#7E7B52', '#6C7059', '#969992', '#646B63', '#6D6552', '#6A5F31',
            '#4D5645', '#4C514A', '#434B4D', '#4E5754', '#464531', '#434750', '#293133', '#23282B', '#332F2C', '#686C5E', '#474A51', '#2F353B', '#8B8C7A', '#474B4E', '#B8B799', '#7D8471'
            ];
        $ralColors3 = [
            '#8F8B66', '#D7D7D7', '#7F7679', '#7D7F7D', '#B5B8B1', '#6C6960', '#9DA1AA', '#8D948D', '#4E5452', '#CAC4B0', '#909090', '#82898F', '#D0D0D0', '#898176', '#826C34', '#955F20',
            '#6C3B2A', '#734222', '#8E402A', '#59351F', '#6F4F28', '#5B3A29', '#592321', '#382C1E', '#633A34', '#4C2F27', '#45322E', '#403A3A', '#212121', '#A65E2E', '#79553D', '#755C48'
            ];
        $ralColors4 = [

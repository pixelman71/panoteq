...
$(document).ready(function(){
	...
	$(".sibar_left .open-sidebar").on("click", function(){
		$(this).parents('main').addClass('page_sidebar');
		$(this).hide();
		$(this).parents('main').find('.close-sidebar').show();
		$(this).parents('main').find('.left_column_fix').addClass('active');
	});
	$(".sibar_left .close-sidebar").on("click", function(){
		$(this).hide();
		$(this).parents('main').removeClass('page_sidebar');
		$(this).parents('main').find('.open-sidebar').show();
		$(this).parents('main').find('.left_column_fix') .removeClass('active');
	});
	// search
	...
	{	
		...
		$(window).scroll(function() {    
			...
			if (scroll >= headerSpaceH) {
				...
				$("#header .header-content").addClass(" animated fadeInDown");
			   $(".page_sidebar #header .header-content").removeClass("animated fadeInDown");
				$(".block-search.open").parents("#header .header-content").removeClass("animated fadeInDown");
			  $('.headerSpace').removeClass('unvisible');
			}else{
			  $("#header").removeClass("scroll-menu");
			  $("#header .header-content").removeClass("animated fadeInDown");

                            ...
                            <div id="modal-full" class="uk-modal-full" uk-modal>
                                <div class="uk-modal-dialog">
                                    ...
                                    <div class="uk-grid-collapse uk-child-width-1-2@s uk-flex-middle" uk-grid>
                                        <div class="uk-background-cover" style="background-color: #ff00aa" uk-height-viewport></div>
                                        <div class="uk-padding-large">
                                            <h1>Couleurs RAL</h1>
                                            <p>Un éventail RAL est fortement recommandé car les couleurs
                                                d'écran sont simplement une indication des couleurs finales. Avec l'éventail
                                                de couleurs RAL physique vous pouvez être sûr de la bonne couleur.</p>
                    ...
                    <li>
                        ...
                        <div class="uk-accordion-content">
                            <div class="uk-margin uk-grid-small uk-child-width-1-1 uk-grid">
                                <div>
                                    <label><input type="radio" class="uk-radio" name="type" value=""> Porte</label>
                                </div>
                                <div class="uk-margin-small-top">
                                    <label><input type="radio" class="uk-radio" name="type" value="">
                                        Casserolier</label>
                                </div>
                                <div class="uk-margin-small-top">
                                    <label><input type="radio" class="uk-radio" name="type" value=""> Tiroir</label>
                                </div>
                                <div class="uk-margin-small-top">
                                    <label><input type="radio" class="uk-radio" name="type" value=""> Bandeau</label>
                                </div>
                            </div>
                        </div>
                    </li>
                                    ...
                                    {block name='product_buy'}
                                        <form action="{$urls.pages.cart}" method="post" id="add-to-cart-or-refresh">
                                            ...
                                            <input type="hidden" name="id_customization"
                                                   value="{$product.id_customization}" id="product_customization_id">

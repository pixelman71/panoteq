...
{block name='header_top'}
  <div class="header-top">
    <div class="container">
<!--    style="background:url({$urls.img_url}logo.svg);" -->
       <div class="row">
	     <div class="col col-xs-12 col-lg-12 col-md-12 display_nav">
			{hook h='displayNav1'}
        </div>
        <div class="header_logo col col-lg-12 col-md-12 col-xs-12">
